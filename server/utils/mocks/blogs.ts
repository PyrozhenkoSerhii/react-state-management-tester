...
export const mockBlogs: Array<TMockBlog> = [
  {
    ...
    image: "https://specialhelps.com/wp-content/uploads/2020/05/Tech.jpg",
    tags: ["tech", "nature"],
    rating: 0,
  },
  {
    title: "Health care",
    content: "Small blog content",
    image: "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcT8kKA8BekN6HPEzzWGviXZmVAc-FyAeiIHkg&usqp=CAU",
    tags: ["health"],
    rating: 0,
  },
];
